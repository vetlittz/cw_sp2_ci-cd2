...
convert_loop :
    ...
    cmp eax, 0
    jz LABEL@AFTER_WHILE_00007FF7297EDF80
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF7297F2628

    ;exit while (in "then"-part of While-operator)
    jmp LABEL@AFTER_WHILE_00007FF7297EDF80

    ;";" (after "then"-part of If-operator)
    mov eax, 1
    LABEL@AFTER_THEN_00007FF7297F2628:
    ...
    ;end of while
    jmp LABEL@WHILE_00007FF7297EDF80
    LABEL@AFTER_WHILE_00007FF7297EDF80:
