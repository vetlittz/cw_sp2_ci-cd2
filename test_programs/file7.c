...
int main() {
    ...
    if (opTemp == 0) goto LABEL__AFTER_WHILE_00007FF7297EDF80;
    ...
    if (opTemp == 0) goto LABEL__AFTER_THEN_00007FF7297F2628;

    //exit while (in "then"-part of While-operator)
    goto LABEL__AFTER_WHILE_00007FF7297EDF80;

    //";" (after "then"-part of If-operator)
    opTemp = 1;
    LABEL__AFTER_THEN_00007FF7297F2628:
    ...
    //end of while
    goto LABEL__WHILE_00007FF7297EDF80;
    LABEL__AFTER_WHILE_00007FF7297EDF80:
