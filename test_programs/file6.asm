...
convert_loop :
    ...
    cmp eax, 0
    jz LABEL@AFTER_WHILE_00007FF634C3C690
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_00007FF634C40D38

    ;continue while (in "then"-part of While-operator)
    jmp LABEL@WHILE_00007FF634C3C690

    ;";" (after "then"-part of If-operator)
    mov eax, 1
    LABEL@AFTER_THEN_00007FF634C40D38:
    ...
    ;end of while
    jmp LABEL@WHILE_00007FF634C3C690
    LABEL@AFTER_WHILE_00007FF634C3C690:
